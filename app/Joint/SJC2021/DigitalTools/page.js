        ...
        <div className="w-[90%] mx-auto bg-[#FFF067] p-2 sm:p-4 md:p-6 text-sm">
          ...
          <div className="relative mb-6 md:mb-8 pt-8 sm:pt-4">
            ...
            <div className="absolute top-0 right-2 sm:right-4 flex flex-col sm:flex-row gap-2 sm:gap-4 text-right">
              ...
              <a
                href="https://forms.gle/MurfmsRMLEtqRUHW9"
                target="_blank"
          ...
          <div className="text-center mb-6 px-2">
            ...
            <p className="text-sm sm:text-base">
              Dr. C. P. Ravikumar,
              <strong> Texas Instruments</strong> Prof. Binod Mishra, IIT
              Roorkee Prof. Kannan Moudgalya, <strong>IIT Bombay </strong>
              (consent awaited) Prof. D. B. Phatak, <strong>IIT Bombay </strong>
              (consent awaited), Mr. C. V. Radhakrishnan,
              <strong> TUG & RiverValley</strong> Prof. Yogananda C. S.,
              <strong>Chairman TUGgroup</strong> (consent awaited) Dr. Reema
              Sahni, <strong>IITD & team</strong> Active Learning group,
              <strong> IIT Bombay </strong>
              Dr. M. Ravi Kumar, <strong>MNITJ</strong> Dr. Arka P. Mazumdar,
              <strong>MNITJ</strong> Dr. Amit M. Joshi, <strong>MNITJ</strong>{" "}
              Dr. E. S. Pilli <strong>MNITJ</strong>
            </p>
          </div>
                ...
                <table className="w-full">
                  ...
                  <tbody className="bg-[#FFE81C] text-base">
                    {[
                      ...
                      "Writing manuscript in Latex- working with figures, tables",
                      "Reviewing manuscripts; Responding to reviewer’s comment",
                      "Mastering Language – Spoken & written; communication skills",
                      "Bibliography management, Mendeley, JabRef",
                      "Online tools- CV, Sharelatex, OverLeaf, Author Kits",
                    ].map((topic, index) => (
                      <tr
                        key={index}
                        className={
