        ...
        <div className="w-[90%] mx-auto bg-[#FFF067] p-2 sm:p-4 md:p-6 text-sm">
          ...
          <div className="relative mb-6 md:mb-8 pt-8 sm:pt-4">
            ...
            <div className="absolute top-0 right-2 sm:right-4 flex flex-col sm:flex-row gap-2 sm:gap-4 text-right">
              ...
              <a
                href="https://forms.gle/a5efmpSvoHRptCnv7"
                target="_blank"
          ...
          <div className="text-center mb-6 px-2">
            ...
            <p className="text-sm sm:text-base">
              <strong>EXPERTS/SPEAKERS -</strong> Prof DVLN Somayajulu-IIITDMK,
              Prof RBV Subramnayam NIT-W, Dr Atul Gupta IIITDMJ, Dr T
              Ramakrishnudu NIT-W, Dr Nagesh Bhattu – NIT AP, Dr Anand Kumar-
              NIT K Surathkal, Industry speakers.
            </p>
          </div>
                    ...
                    {[
                      {
                        ...
                        topic:
                          "Matrices, Vectors, Vector Spaces, Matrix Decomposition, Singular Value Decomposition, Statistical Measures, Probability basics, density function, variance, conditional probability, Markov Chains",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        topic:
                          "Regression, Classification – Decision Trees, Naïve Bayesian Classifier, Clustering, Handling Large Datasets: MapReduce",
                      },
                      {
                        name: "R for Data Science",
                        topic:
                          "Data Wrangling, Data Visualization, Programming",
                      },
                      {
                        name: "Python for Data Science",
                        topic: "Normal Python, NumPy, Pandas, Matplotlib",
                      },
                      {
                        name: "Deep Learning",
                        topic: "",
                      ...
                      {
                        name: "Scikit, Keras and TensorFlow",
                        topic: "Practice on ML topics",
                      },
                    ].map((item, index) => (
                      <tr
                        key={index}
