        ...
        <div className="w-[90%] mx-auto bg-[#FFF067] p-2 sm:p-4 md:p-6 text-sm">
          ...
          <div className="relative mb-6 md:mb-8 pt-8 sm:pt-4">
            <h1 className="text-center text-xl sm:text-2xl md:text-3xl font-bold font-['Quicksand']">
              Scientific Computation and GUI Development Using MATLAB
            </h1>
            <div className="absolute top-0 right-2 sm:right-4 flex flex-col sm:flex-row gap-2 sm:gap-4 text-right">
              <a
                href="https://drive.google.com/file/d/1063QGgWCDuIkXwQ5lGUXWTgpM9B7WTPQ/view?usp=sharing"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 px-2">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-4 sm:pl-6 text-sm sm:text-base">
                ...
                <li className="ml-4">Dr. Rajesh Saha, MNIT Jaipur</li>
          ...
          <div className="text-center mb-6 px-2">
            ...
            <p className="text-sm sm:text-base">
              <strong>EXPERTS/SPEAKERS -</strong> Dr. Pulak Mohan Pandey,
              Professor, IIT Delhi; Dr. Prashant K. Jain, Professor, IIITDM
              Jabalpur; Dr. Pavan K. Kankar, Associate Professor, IIT Indore;
              Dr. Amit Singh, Assistant Professor, MNIT Jaipur; Dr. Mohammad
              Taufik, Assistant Professor, MANIT Bhopal; Dr. Narendra Kumar,
              Assistant Professor, NIT Jalandhar; Dr. Ankit Nayak, Assistant
              Professor, Banasthali Vidyapeeth; Dr. Vilshal Francis, Assistant
              Professor, LPU Punjab; Dr. R B Pachori, Professor, IIT Indore
            </p>
          </div>
                ...
                <div className="px-4">
                  <ul className="list-disc space-y-4 text-sm">
                    <li className="break-words">
                      <strong>Introduction to MATLAB User Interface,</strong>
                    </li>
                    <li className="break-words">
                      <strong> Basic Operations,</strong>
                    </li>
                    <li className="break-words">
                      <strong>Using MATLAB as Calculator,</strong>
                    </li>
                    <li className="break-words">
                      <strong>Handling Variables,</strong>
                    </li>
                    <li className="break-words">
                      <strong>Data Format,</strong>
                    </li>
                    <li className="break-words">
                      <strong>Expressions and Matrices,</strong>
                    </li>
                    <li className="break-words">
                      <strong>Conditional/logical Statement,</strong>
                    </li>
                    <li className="break-words">
                    ...
                    <li className="break-words">
                      <strong>Writing Functions,</strong>
                    </li>
                  </ul>
                </div>
                <div className="px-4">
                  <ul className="list-disc space-y-4 text-sm">
                    <li className="break-words">
                      <strong>Modifying plots using property editor,</strong>
                    </li>
                    <li className="break-words">
                      <strong>Automating Plots,</strong>
                    </li>
                    <li className="break-words">
                      <strong>
                        Building Graphical User Interface (GUI) Basics,
                      </strong>
                    </li>
                    <li className="break-words">
                    ...
                    <li className="break-words">
                      <strong>curve fitting, and interpolations,</strong>
                    </li>
                    <li className="break-words">
                      <strong>Debugging and Troubleshooting programs,</strong>
                    </li>
                    <li className="break-words">
                      <strong>Data Input/Output in Various Format,</strong>
                    </li>
                    <li className="break-words">
                      <strong>2D Plotting Visualization Using MATLAB,</strong>
                    </li>
                    <li className="break-words">
                      <strong>3D Plots,</strong>
                    </li>
                  </ul>
                </div>
                <div className="px-4">
                  <ul className="list-disc space-y-4 text-sm">
                    <li className="break-words">
                      <strong>
                        Development Tools and Programming Techniques,
                      </strong>
                    </li>
                    <li className="break-words">
                    ...
                    <li className="break-words">
                      <strong>
                        radio buttons, and other windows GUI options.
                      </strong>
                    </li>
                    <li className="break-words">
                      <strong>
                        Generating Executable Files and Stand-Alone
                        Applications,
                      </strong>
                    </li>
                    <li className="break-words">
                      <strong>MATLAB Applications demonstration.</strong>
                    </li>
                  </ul>
                </div>
              </div>
...
export default ScientificComputation;
